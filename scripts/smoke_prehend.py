#!/usr/bin/env python3
"""Live smoke test of the prehend experience-memory loop against a real LLM.
...
Usage:
    .venv/bin/python scripts/smoke_prehend.py \\
        --base-url http://localhost:8080/v1 \\
        --model google/gemma-4-12b-it \\
        --bank-dir /tmp/prehend_smoke_bank

While it runs, confirm the wire in another shell (the load-bearing gotcha):
    ss -tnp | grep $(pgrep -f smoke_prehend)   # MUST show :8080
"""
...
DEFAULT_BANK_DIR = "/tmp/prehend_smoke_bank"
